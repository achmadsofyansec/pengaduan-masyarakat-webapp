...
if(isset($_GET['url'])) {
    switch ($_GET['url']) {
        ...
        case 'tanggapi-pengaduan':
            ...
            break;
        case 'beri-tanggapandetail':
            include 'beri-tanggapandetail.php';
            break;
        case 'tanggapan':
              ...
              <div class="col-lg-12 mb-4">
                ...
                <div class="card border-left-warning   shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Pengaduan Sudah Diverivikasi</div>
